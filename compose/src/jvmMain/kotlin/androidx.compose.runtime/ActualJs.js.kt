...
//    private val delegate = atomic(value)
    actual fun get(): V = error("Not implemented")

    actual fun set(value: V) {
        error("Not implemented")
    }

    actual fun getAndSet(value: V): V = error("Not implemented")

    actual fun compareAndSet(expect: V, newValue: V): Boolean = error("Not implemented")
}
...
actual val DefaultMonotonicFrameClock: MonotonicFrameClock = error("Not implemented")
