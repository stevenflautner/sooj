            ...
            configureMultiplatform {
                jvm("server") {
                    compilations.all {
                        ...
                        // Without IR delegated property assignment throws:
                        // JVM internal error: Augment assignment and increment are not supported for local delegated properties and inline properties
                        // see: https://youtrack.jetbrains.com/issue/KT-43912
